      ...
      <section className='pb-10'>
        <div className='container mx-auto text-center'>
          <p className='mb-2 sd:text-xl xz:text-base font-semibold'>
            Нужен инструмент? Не теряйте времени на поиски и заботы о покупке дорогостоящего оборудования. Воспользуйтесь нашим прокатом строительного инструмента в Молодечно и получите доступ к широкому ассортименту высококачественного оборудования прямо сейчас!
          </p>
        </div>
      </section>
